...
def get_gemma_recommendation(
    ...
    if category == "운동":
        prompt += (
            ...
            "- 운동 제한 사항이 있는 경우 대체 운동을 제안하세요.\n"
            "- 운동 방법 설명이나 주의사항은 간략하게 작성하세요.\n"
            "- 운동 계획은 다음 형식으로 작성하세요:\n"
            "운동 예시:\n"
            "[{'요일': '월', '운동': [{'종류': '달리기', '시간': 30, '칼로리 소모': 300}, {'종류': '스트레칭', '시간': 15, '칼로리 소모': 50}]"
        )
        ...
        prompt += (
            ...
            "- 식사 방법 설명이나 주의사항은 간략하게 작성하세요.\n"
            "식단 예시:\n"
            "[{'요일': '월', '아침': {'메뉴': '계란 + 오트밀', '칼로리': 300}, '점심': {'메뉴': '닭가슴살 샐러드', '칼로리': 400}, '저녁': {'메뉴': '구운 채소 + 연어', '칼로리': 450}]"
        )
        allergen_foods = []
        for info_type, info_value in additional_info:
