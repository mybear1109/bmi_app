...
# 모델 로드 함수 (MPS에서 메모리 문제를 피하기 위해 CPU로 변경)
def load_gemma_model(model_name):
    ...
    try:
        ...
        pipe = pipeline(
            ...
            model=model_name,
            tokenizer=tokenizer,
            model_kwargs={"torch_dtype": torch.float32, "use_auth_token": HF_API_KEY},
